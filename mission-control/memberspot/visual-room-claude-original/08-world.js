...
function drawPhoto(im, x, y, w, h, a) {
  if (!im.complete || !im.naturalWidth || a < .01) return;
...
function drawPyramid(t, show) {
  var P = G.pyr, pa = photoAlpha(t, 0, show), sz = P.w * 1.9;
...
function drawTemple(t, show) {
  var T = G.temple, s = G.s * 1.1, winter = seasonAmt(4), pa = photoAlpha(t, 30, show), ph = THd * .62;
